...
cd -P -- "/mnt/e/gitkraken/gourd/mrcpsp/local/runs_001-560/run_007" || exit
...
env time --append --output=driver.log --format="wall_clock_time = %e\nsystem_time = %S\nuser_time = %U" \
   sh -c '( /mnt/e/gitkraken/pumpkin/target/release/examples/mrcpsp "--timeout" "30000" "../../../instances/mm_j30/j30_09_6.dzn" > run.log 2> run.err ) || printf "exit_code = $?\n" > driver.err'
