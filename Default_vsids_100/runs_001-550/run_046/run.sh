...
cd -P -- "/mnt/e/gitkraken/gourd/mrcpsp/local/runs_001-550/run_046" || exit
...
printf "name = \"_j30_13_5\"\nprogram = \"pumpkin\"\nfile = \"["../../../instances/mm_j30/j30_13_5.dzn"]\"\n" > driver.log
...
env time --append --output=driver.log --format="wall_clock_time = %e\nsystem_time = %S\nuser_time = %U" \
   sh -c '( /mnt/e/gitkraken/pumpkin/target/release/examples/mrcpsp "--timeout" "100000" "../../../instances/mm_j30/j30_13_5.dzn" > run.log 2> run.err ) || printf "exit_code = $?\n" > driver.err'
